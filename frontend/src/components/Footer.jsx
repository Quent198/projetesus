  ...
  return (
    <footer className="footer p-20 bg-base-200 text-base-content">
      ...
      <nav>
        ...
        <a href="/legalnotice" className="link link-hover">Mentions légales</a>
        <a href="/privacypolicy" className="link link-hover">Politique de confidentialité</a>
      ...
      <nav>
        ...
        <a className="link link-hover">Auteurs</a>
        <a className="link link-hover">Articles</a>
      </nav>
      <nav className="flex flex-row w-25">
        <svg
